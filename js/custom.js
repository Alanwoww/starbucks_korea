...
// notice swiper
const swiper = new Swiper(/* '.notice-line .inner__left .swiper' */ '.swpier .swiper_wrapper .swiper_slid', {
  direction : 'verticel',
  autoplay : true,
  loop : true
});
...
const swiper2 = new Swiper('.promotion .swiper', {
  ...
  centeresSlides : true, // 1번 슬라이드를 가운데 배치
  loop : true,
  autoplay : {
    delay : 5000
  },
